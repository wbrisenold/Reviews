...
<head>
	...
	<title>Stairlifts Liverpool</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Liverpool.php" class="nav-link active">Liverpool</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Liverpool</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>Our advisers can help you find a reputable stairlift supplier local to the Liverpool and Merseyside area.</p>
						<p>We can arrange free no obligation quotes throughout the city and across the North West region, including The Wirral, Chester, Warrington, Southport and Wigan.</p>
						<p>The companies we recommend offer high quality stairlifts at competitive prices and provide great customer service. They can carry out free home visits in your local area to assess your needs and measure your stairs.
						</p>
						<p>To arrange a free home visit or find out more information call our Liverpool office on 0151 205 0825 or fill out the form below.</p>
					</ul>
				</div>
			</div>
		</div>
