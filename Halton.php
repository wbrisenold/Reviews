				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Halton.php" class="nav-link active">Halton</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Halton Stairlifts</h1>
		<div class="container-fluid">
			<div class="row">
	...
	<div class="container-fluid top_area">
		<h1 class="display-3">Halton Stairlifts Review</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6 row sub_top_area">
					<ul>
						<p>Halton offer a fast next day installation service for people who need a stairlift urgently. The company has its own team of engineers for fitting their stairlifts as well as carrying out repairs and maintenance. Customers are able to buy service and repair warranties at a fixed price to cover their stairlift in the unlikely event of a breakdown.</p>
						<p>Halton Stairlifts is approved by Checkatrade, where you can read independent customer reviews. You can also compare ratings and reviews on Trustpilot.com and Feefo.com.</p>
						<p>Halton sell a range of straight and curved stairlifts to fit most types of staircases, including narrow stairs, at prices to suit all budgets. They have models to meet different individual needs, such as heavy duty stair lifts, outdoor versions and lifts with perch seats.</p>
					</ul>
				</div>
				<div class="col-sm-6">
					<ul>
						<h1>They offer reconditioned straight stairlifts from leading manufacturers such as:</h1>
						<ul>
							<li>Acorn</li>
							<li>Brooks</li>
							<li>Handicare</li>
				...
				<div class="col-sm-12  sub_top_area2">
					<p>Halton’s reconditioned stairlifts are second-hand models that have been previously owned by someone else and refurbished to ensure they are in a safe working order. Prices for reconditioned stairlifts are cheaper than for brand new ones.</p>
					<p>If you are concerned about the cost of buying a stairlift, Halton do offer interest free finance to assist you making your purchase. An alternative to consider is hiring a stairlift. Halton offer a stairlift rental service.</p>
					<p>Renting can be a cost-effective solution if you need a stairlift for just a short time, perhaps while you recover from an operation, or maybe if you just want to try a stairlift before you buy.</p>
					<p>Whatever you choose to do, we always recommend getting at least three written quotations so you can make an informed choice about which stairlift is right for you.</p>
