...
<head>
	...
	<title>Stairlifts Birmingham</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Birmingham.php" class="nav-link active">Birmingham</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Birmingham</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If you’re looking for a local stairlift supplier in the Birmingham area, we can help.</p>
						<p>We can put you in touch with reputable stairlift companies operating throughout the West Midlands and Black Country. Areas that our trusted suppliers cover include Solihull, Dudley, Walsall, Wolverhampton, Coventry, Staffordshire, Warwickshire and Worcestershire.</p>
						<p>We only recommend companies that have a track record of providing top quality stairlifts at reasonable prices. Our trusted suppliers also offer a high standard of customer service and aftersales care.</p>
						<p>To get a free no obligation quote and save up to 30% either fill out the form above or call our Birmingham office on 0121 330 1370 and we will be pleased to assist you.</p>
