				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="London.php" class="nav-link active">london</a>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						...
						<p>The local suppliers we recommend are reputable companies that sell reliable stairlifts backed up by outstanding customer care.
						</p>
