...
<head>
	...
	<title>Stairlifts Manchester</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Manchester.php" class="nav-link active">Manchester</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Manchester</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>In the North of England we can recommend trusted stairlift companies that cover your local area.</p>
						<p>We can arrange free no obligation quotes from local suppliers across Northern England. We can recommend reputable companies that cover towns and villages throughout the North. Areas covered include Greater Manchester, Liverpool, Leeds, Lancashire and Yorkshire.</p>
						<p>The companies we suggest have a reputation for supplying quality stairlifts at affordable prices. They also look after their customers and offer good after sales care.</p>
						<p>To arrange a home visit or request more information, either fill out the form or phone our Manchester office on 0161 262 1075.</p>
