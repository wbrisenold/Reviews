				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Exeter.php" class="nav-link active">Exeter</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Exeter</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If you’re looking for a local stairlift supplier covering Exeter, Plymouth and surrounding areas, you’ve come to the right place.</p>
						<p>We can put you in touch with stairlift suppliers throughout Devon and Cornwall. We only recommend reputable companies that provide high quality stairlifts and deliver excellent customer service.</p>
						<p>We’ve negotiated exclusive discounts with trusted suppliers that cover Exeter and other places nearby in the South West.
						</p>
						<p>You could save up to 30% on the cost of your stairlift by using one of our trusted local suppliers.</p>
						<p>Simply fill out the form below or phone our Exeter number on 01392 510919 to arrange a free no obligation quote.</p>
					</ul>
				</div>
			</div>
		</div>
