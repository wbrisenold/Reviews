...
<head>
	...
	<title>Stairlifts Coventry</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Coventry.php" class="nav-link active">Coventry</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Coventry</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If you live in the Coventry area our team can help you find a trusted stairlift supplier local to you. We only recommend companies that supply quality stairlift models and offer a high standard of customer care, combined with competitive prices.</p>
						<p>We can arrange free no obligation quotes in Coventry, Warwickshire and the rest of the West Midlands region. Our recommended suppliers cover towns and villages across central England, including Nuneaton, Warwick, Royal Leamington Spa, Rugby and Leicester.</p>
						<p>We can help you find a reputable stairlift supplier in your local area. Simply call our Coventry number on 024 7607 0195 or fill out the form below.
