...
<head>
	...
	<title>Dolphin Stairlifts</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Dolphin.php" class="nav-link active">Dolphin</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Dolphin Stairlifts</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>Dolphin is a nationwide group of stairlift suppliers with local branches throughout the UK. The first Dolphin Stairlifts franchise was created in 1990 in Harrow, Middlesex. In 1996 it became Dolphin Mobility, based in Chobham, Surrey, supplying stairlifts across London and the South East.</p>
						<p>There are now Dolphin branches across the country. Areas covered include Bristol and the South West, Yorkshire, Kent, East Anglia, the Midlands, the North East, Scotland and South Wales.</p>
						<p>Dolphin Mobility is an approved dealer for a range of stairlifts from manufacturers such as Bison Bede, Brooks, Meditek, Platinum and Stannah.</p>
						<p>Given that Dolphin sells a range of different brands of stairlifts, they can offer models to fit most types of stairs, including narrow, steep and curved ones. The company supplies a wide choice of new straight and curved stairlifts.</p>
						<p>In addition, it sells a variety reconditioned models for straight stairs backed up by a full parts and labour warranty. The company also offers reconditioned curved Stannah stairlifts that come with a brand new tailor made track.</p>
						<p>Dolphin also offers a rental service, which may be the most cost effective solution for some people. Dolphin only offer rental stairlifts for straight staircases, as the cost of building a custom made rail for curved stairs is too expensive to be viable.</p>
						<p>Dolphin offers a stairlift removal service. They will remove a stairlift bought from them free of charge. In some cases they may be able to remove a used stairlift that was bought elsewhere. The company will sometimes buy second-hand stairlifts under 3 years old that they can refurbish and re-sell.</p>
					</ul>
				</div>
			</div>
		</div>
