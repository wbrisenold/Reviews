...
<head>
	...
	<title>Stairlifts Glasgow</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Glasgow.php" class="nav-link active">Glasgow</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Glasgow</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If you’re looking for a local stairlift company in the Glasgow area, we can help. We can arrange free no obligation quotes from trusted suppliers that cover Glasgow and surrounding areas</p>
						<p>We can also recommend reputable stairlift companies that operate in other parts of Scotland, including Edinburgh.</p>
						<p>In order for us to recommend a supplier they must offer high quality, reliable stairlifts and provide an excellent level of customer service.
						</p>
						<p>We’ve been able to negotiate discounts of up to 30% with local suppliers in the Glasgow region, so you could save money on the price.</p>
						<p>Just complete the form or call our Glasgow office on 0141 214 0082 to find out how much you can save.</p>
					</ul>
				</div>
			</div>
		</div>
