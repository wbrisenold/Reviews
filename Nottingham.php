...
<head>
	...
	<title>Stairlifts Nottingham</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Nottingham.php" class="nav-link active">Nottingham</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Nottingham</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If you’re looking for a stairlift in the Nottingham area, our local advisers can help.</p>
						<p>We can put you in touch with our recommended suppliers that cover Nottingham as well as villages and towns across the whole East Midlands region.</p>
						<p>We only recommend trusted stairlift companies that provide quality products at reasonable prices. They also deliver excellent customer service and aftersales care.
						</p>
						<p>To get a no obligation quote or arrange a free home visit to survey your stairs, call our Nottingham office on on 0115 839 0310 or fill out the form above.</p>
					</ul>
				</div>
			</div>
		</div>
