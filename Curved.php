			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							<a href="Curved.php" class="nav-link active">Curved</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Curved Stairlifts</h1>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>If your stairs bend or turn corners then you will need a curved stairlift with a custom made track to fit the exact layout of your staircase. The tracks are either bent into shape or made up of modular bends and can be fitted to almost any type of stairs, even spiral staircases.</p>
						<p>Being custom made means curved stairlifts will have a higher price. There is usually a longer wait for delivery and installation than for a basic straight stairlift model.</p>
						<p>However, the purpose built track does offer more flexibility, such as including a parking bend to allow the seat to be parked clear of the top or bottom of the stairs. an informed decision about which stairlift offers the best solution for you. </p>
					</ul>
				</div>
			</div>
		</div>
