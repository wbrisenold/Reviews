...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Brooks Stairlifts</h1>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<p>Britain’s first stairlift was designed in 1972 by engineer Frederick Brooks for his wife Grace, who was struggling with the stairs due to rheumatoid arthritis. This is how Brooks Stairlifts came about and over 40 years later Brooks stairlifts are sold throughout the country <br> <br>

						As the company grew they added curved stairlifts to their range. Bison Bede was bought by Acorn in 2008. Now Bison stairlifts are sold by approved dealers throughout the UK. Their models can be installed on nearly every type of staircase, sometimes where other makes won’t fit. <br><br>
						Brooks offer only straight stairlifts. Their Lincoln model runs on automatically recharged DC batters and is designed to be safe, comfortable and easy to use. It is operated with a joystick armrest paddle. It also has a wireless remote control system, which is handy when more than one person needs to use the stairlift. <br><br>The seat swivels to make it easier to get on and off, and can be locked in either a 45 or 90 degree position. The Lincoln has built in safety sensors to halt the stairlift if there is an obstacle blocking its path. The slimline design, with fold up arms, seat and foot rest, means there is plenty of space for other people to walk up and down the stairs when it’s not in use. <br><br>
	...
	<div class="container-fluid second_area">
		<div class="container-fluid">
			<h1 class="display-3">Brook Stairlift Reviews</h1>
			<hr>
			<div class="row">
				<div class="col-sm-6" style="padding-top: 2%">

					<p>In a recent Which survey, Acorn, which sells Brooks stairlifts, received an overall score of 68 percent for customer satisfaction.
					</p>
					<p>It has a slimline design, so it can be a good option on narrow or steep stairs. It measures under 12 inches (300mm)wide when it’s folded away against the wall. This allows other users of the staircase more space to safely climb the stairs.</p>
					<p>Respondents paid an average price of £2,307 for a stairlift. The average price paid for a used stairlift was £1,214.</p>

				</div>
				<div class="col-sm-6">
					<h1>The stairlifts achieved good ratings for:</h1>
					<ul>
						<li>Useability</li>
						<li>Reliability</li>
						<li>Personal Suitability</li>
						<li>Suitability for the Home and Stairs</li>
	...
	<div class="container-fluid second_area">
		<div class="container-fluid">
			<h1 class="display-4">Brooks Lincoln Straight Stairlift</h1>
			<hr>
			<div class="row">
				<div class="col-sm-6">
					<h1>The Brooks Lincoln stairlift is designed for use on straight stairs.</h1>
					<img src="Images/brooks-stairlift.jpg" alt="">
				</div>
				<div class="col-sm-6">
					<h1>Features</h1>
					<ul>
						<li>Runs on maintenance-free automatically recharged DC power pac</li>
						<li>Designed to stop and start smoothly and safely</li>
						<li>Operated with an easy to use joystick on the arm rest</li>
						<li>12 months guarantee</li>
						<li>Fits directly to the stairs so won’t damage the wall</li>
						<li>Swivel seat for safe mounting and dismounting</li>
						<li>Slimline design with foldaway arms, seat and foot rest</li>
						<li>Safety sensors to safely halt the lift if anything is blocking its route</li>
					</ul>
				</div>
