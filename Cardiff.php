...
<head>
	...
	<title>Stairlifts Cardiff</title>
</head>
				...
				<ul class="navbar-nav ml-auto">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="Cardiff.php" class="nav-link active">Cardiff</a>
...
?>
	...
	<div class="container-fluid top_area">
		<h1 class="display-1">Stairlifts Cardiff</h1>
		<hr>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-12">
					<ul>
						<p>Our local Cardiff office can recommend stairlift suppliers in the local area and throughout Wales.</p>
						<p>Our trusted suppliers cover the whole of South Wales, including Cardiff, Newport, Bridgend, Swansea and Neath, as well as the Valleys and rural areas.</p>
						<p>We can also recommend companies that operate locally in the towns and villages of North, Mid and West Wales. We choose only reputable suppliers that offer top quality stairlifts that are backed up by a high level of after sales care. They offer customers reliable products at affordable prices and you could save up to 30%.</p>
						<p>Complete the form or call our Cardiff office on 02920 140 185 to arrange a free no obligation quote or simply get more information</p>
